...
trait QuoteContextReflection { quoteContextSelf: QuoteContext =>
  ...
  /////////////////////
    ...
    */
    ...
    trait TreeAccumulator[X] extends reflect.TreeAccumulator[X] {
      val quoteContext: quoteContextSelf.type = quoteContextSelf
    }
