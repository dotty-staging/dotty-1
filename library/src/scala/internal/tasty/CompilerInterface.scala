...
trait CompilerInterface { self: QuoteContext =>

  import self.tasty._

  val internal: InternalModule

  trait InternalModule { self: internal.type =>
...
object CompilerInterface {
  ...
  private[scala] def quoteContextWithCompilerInterface(qctx: QuoteContext): qctx.type & scala.internal.tasty.CompilerInterface =
    qctx.asInstanceOf[qctx.type & scala.internal.tasty.CompilerInterface]
