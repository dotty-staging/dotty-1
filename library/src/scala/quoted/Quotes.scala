...
trait Quotes { self: runtime.QuoteUnpickler & runtime.QuoteMatching =>
  ...
  trait Reflection { self: reflect.type =>
    ...
    */
    ...
    /** `TypeTest` that allows testing at runtime in a pattern match if an `Selector` is a `SimpleSelector` */
    given SimpleSelectorTypeTest as TypeTest[Selector, SimpleSelector] = SimpleSelectorTypeTestImpl
    ...
    /** `TypeTest` that allows testing at runtime in a pattern match if an `Selector` is a `RenameSelector` */
    given RenameSelectorTypeTest as TypeTest[Selector, RenameSelector] = RenameSelectorTypeTestImpl
    ...
    /** `TypeTest` that allows testing at runtime in a pattern match if an `Selector` is an `OmitSelector` */
    given OmitSelectorTypeTest as TypeTest[Selector, OmitSelector] = OmitSelectorTypeTestImpl
    ...
    given GivenSelectorTypeTest as TypeTest[Selector, GivenSelector] = GivenSelectorTypeTestImpl
