...
object report:
  ...
  def warning(msg: => String)(using qctx: Quotes): Unit =
    quotes.reflect.Reporting.warning(msg, quotes.reflect.Position.ofMacroExpansion)

  /** Report a warning at the on the position of `expr` */
  def warning(msg: => String, expr: Expr[_])(using qctx: Quotes): Unit =
    quotes.reflect.Reporting.warning(msg, expr.unseal.pos)
