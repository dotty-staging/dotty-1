...
//     sbtPublishCommand = """;set scalacOptions in Global += "-Yerased-terms" ;library/packageBin""",
//   )
...
class PublishStdLibTest:
  @Ignore @Test def stdLib213 = projects.stdLib213.publish()
